...
The average FPS for both renderers is given in Figure \ref{fig:RealTimeFPSResults}\footnote{All FPS captures were done with the entire scene in view of the camera. The hardware of the test device consisted of an NVIDIA GeForce RTX 3070 GPU, and an AMD Ryzen 3700X CPU.}. The scene complexity is expressed using triangle count as that is more expressive than giving the number of light fixture models.
