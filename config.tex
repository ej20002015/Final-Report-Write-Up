...
\newcommand{\projectTitle}{The Benefits of Using Physically Based Shading Models in Real-time Rendering}
\newcommand{\fullname}{Evan James}
\newcommand{\degreeTitle}{Computer Science (Digital \& Technology Solutions) BSc}
	% e.g. "BSc Computer Science"
\newcommand{\session}{2021/22}
	% "Session" means the academic year, i.e. 2021/22.
\newcommand{\module}{COMP3932 Synoptic Project}
